...
export function NewAccountModal() {
    const { closeNewAccountModal, isNewAccountModalOpen, errors, handleSubmit, register, control, isLoading } = useNewAccountModalController()
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mt-10 flex flex-col gap-4">
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, value } }) => (
                            <Select
                                ...
                                options={[{ value: "CHECKING", label: "Conta Corrente" },
                    ...
                    <Controller
                        ...
                        defaultValue=""
                        render={({ field: { onChange, value } }) => (
                            <ColorsDropdownInput onChange={onChange} value={value} error={errors.color?.message} />
